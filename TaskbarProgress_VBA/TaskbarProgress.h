...
extern "C" TaskbarProgressVBA_API void __stdcall SetThumbButtonCallback(CallbackFunc callback);
extern "C" TaskbarProgressVBA_API void __stdcall AddThumbButton(HWND hwnd);
